...
import RatingCard from "@/components/side-cards/RatingCard.vue";
	...
	<Dropdown width="1200px">
		...
		<template #content>
			<div class="flex flex-row justify-between items-center gap-2">
				...
				<div class="flex flex-col items-end gap-5 w-full max-w-174.25">

					<!-- Input Container -->
					<div class="box-border flex flex-col items-start p-10 w-full h-117.25 bg-[#EAEAEA] rounded-[20px] self-stretch">
						<textarea
								class="w-full h-full bg-transparent border-none outline-none resize-none italic font-normal text-[16px] leading-4.75 text-[#676767] placeholder-[#676767]"
					...
					<div class="flex flex-row items-end gap-5">
						...
						<BlueButton>
							...
							<span class="font-semibold text-[16px] leading-4.75 text-white">
								Upload
							</span>
						</BlueButton>
						...
						<!-- Submit Button -->
						<BlueButton>
							<span class="font-semibold text-[16px] leading-4.75 text-white">Submit</span>
						</BlueButton>
					</div>
